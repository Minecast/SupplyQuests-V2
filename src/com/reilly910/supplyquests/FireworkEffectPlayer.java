...
public class FireworkEffectPlayer {
	 ...
	 * @throws Exception
	 */
	public boolean playFirework(World world, Location loc, FireworkEffect fe) throws Exception {
		...
		/*
		 * The reflection part, this gives us access to funky ways of
	...
	/**
	 * Internal method, used as shorthand to grab our method in a nice
	 * friendly manner
	 * 
	 * @param cl
	 * @param method
